...
# Load data
df = pd.read_csv('c:/Github/Papers/SOSSTSrecognition/KNN/practice.csv')
...
plt.tight_layout()
plt.savefig('c:/Github/Papers/SOSSTSrecognition/KNN/torque_analysis_1.png')
...
plt.tight_layout()
plt.savefig('c:/Github/Papers/SOSSTSrecognition/KNN/torque_analysis_2.png')

print("Plots saved as torque_analysis_1.png and torque_analysis_2.png")
