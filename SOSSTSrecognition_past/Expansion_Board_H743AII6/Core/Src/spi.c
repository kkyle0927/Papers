...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB14     ------> SPI2_MISO
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_13|GPIO_PIN_15|GPIO_PIN_14);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC11     ------> SPI3_MISO
    */
    HAL_GPIO_DeInit(GPIOC, GPIO_PIN_12|GPIO_PIN_10|GPIO_PIN_11);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE5     ------> SPI4_MISO
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_2|GPIO_PIN_6|GPIO_PIN_5);
